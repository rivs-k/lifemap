...
// contenu (1) : c'est cet écart entre les couches qui donne la profondeur.
    ...
    useEffect(() => {
        ...
        function createParticles() {
            ...
            particles = Array.from({ length: count }, () => ({
                ...
                speedX: (Math.random() - 3.5) * 0.12,
                speedY: (Math.random() - 2.5) * 0.12,
        ...
        function animate() {
            ...
            particles.forEach((p) => {
                ...
                // La position de dessin tient compte du scroll, mais on la ramène
                // toujours dans l'écran : sans ce repli, les particules finiraient
                // par sortir du canvas et le fond se viderait en bas de page.
